...
public class HUDOverlayHandler {
    ...
    public void onPreRender(RenderGameOverlayEvent.Pre event) {
        ...
        if (!ModConfig.SHOW_FOOD_EXHAUSTION_UNDERLAY) return;
    ...
    public void onRender(RenderGameOverlayEvent.Post event) {
        ...
        if (!ModConfig.SHOW_FOOD_VALUES_OVERLAY && !ModConfig.SHOW_SATURATION_OVERLAY) return;
        ...
        // saturation overlay
        if (ModConfig.SHOW_SATURATION_OVERLAY) drawSaturationOverlay(0, stats.getSaturationLevel(), mc, left, top, 1f);
